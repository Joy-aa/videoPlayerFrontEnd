...
<!--          <el-image src="http://10.214.242.155:7667/img/background/cifar_1.gif" style="width: 50px; height: 50px; float: left"/>-->
...
<!--          <el-image src="http://10.214.242.155:7667/img/background/cifar_3.gif" style="width: 50px; height: 50px; float: right"/>-->
<!--        </div>-->
      ...
      <el-main style="background-color: white" v-loading="resultLoading">
        ...
        <div class="holly-detect">
          <el-select v-model="chosenModel" placeholder="请选择神经网络模型" size="large">
            <el-option key="6" label="SimpleConvNet" value="SimpleConvNet" />
          </el-select>
          <el-select  v-model="chosenAlgorithm" placeholder="请选择推理算法" size="large">
            ...
            <el-option key="6" label="Saliency" value="Saliency" />
            <el-option key="6" label="DeepLift" value="DeepLift" />
          </el-select>
