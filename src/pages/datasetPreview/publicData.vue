          ...
          <el-col :span="16">
            <el-row class="demo-image">
              ...
              <el-col :span="6" class="blockpublic">
                ...
                <span>CIFAR数据集</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10001)" type="success" plain>查看数据集</el-button>
                <br>
                <el-button class="dataintro" @click="showDialog" type="warning" plain>数据集介绍</el-button>
        ...
        <el-row>
          ...
          <el-col :span="16">
            <el-row class="demo-image">
              ...
              <el-col :span="6" class="blockpublic">
                <div class="dataintro" />
                <span>ImageNet数据集</span>
                <br>
                <el-button class="lookdata" @click="checkOut(10002)" type="success" plain>查看数据集</el-button>
                <br>
                <el-button class="dataintro" @click="showDialog2" type="warning" plain>数据集介绍</el-button>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="4"/>
...
<!--      background: url('http://10.214.242.155:7667/img/background/background_overallpreview.jpg') no-repeat 0% 20%/ cover;-->
      <el-dialog class="scrollable" v-model="dialogVisible" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible = false" :append-to-body="true" title="CIFAR数据集介绍"  >
            ...
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/hinton.jpg']"
                    :src="`http://10.214.242.155:7667/img/background/hinton.jpg`"
                />
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/cifar-10.png']"
                    :src="`http://10.214.242.155:7667/img/background/cifar-10.png`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/cifar-100.png']"
                    :src="`http://10.214.242.155:7667/img/background/cifar-100.png`"
                />
              ...
              <el-tab-pane label="English" name="en">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/hinton-10.jpg']"
                    :src="`http://10.214.242.155:7667/img/background/hinton.jpg`"
                />
                <div style="text-align: left; margin: 10px 0;">
      ...
      <el-dialog class="scrollable" v-model="dialogVisible2" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible2 = false" :append-to-body="true" title="ImageNet数据集介绍"  >
        <div class="dialog-container">
          <div class="language-switch">
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/feifei2.jpeg']"
                    :src="`http://10.214.242.155:7667/img/background/feifei2.jpeg`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/ISVRC.jpg']"
                    :src="`http://10.214.242.155:7667/img/background/ISVRC.jpg`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/imgnet_end.jpg']"
                    :src="`http://10.214.242.155:7667/img/background/imgnet_end.jpg`"
                />
      ...
      <el-dialog class="scrollable" v-model="dialogVisible3" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible3 = false" :append-to-body="true" title="VOC数据集介绍"  >
        <div class="dialog-container">
          <div class="language-switch">
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc1.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc1.png`"
                />
                <el-image
                    style="width: 100%; height: 100%"
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc2.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc2.png`"
                />
                <el-image
                    style="width: 100%; height: 100%"
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc3.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc3.png`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc4.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc4.png`"
                />
                <ul style="text-align: left">
                  <li>
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc5.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc5.png`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/voc6.png']"
                    :src="`http://10.214.242.155:7667/img/background/voc6.png`"
                />
      ...
      <el-dialog class="scrollable" v-model="dialogVisible4" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible4 = false" :append-to-body="true" title="COCO数据集介绍"  >
        <div class="dialog-container">
          <div class="language-switch">
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/coco1.png']"
                    :src="`http://10.214.242.155:7667/img/background/coco1.png`"
                />
                <div style="text-align: left; margin: 10px 0;">
                ...
                <ul style="text-align: left">
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco2.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco2.png`"
                    />
                  </li>
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco3.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco3.png`"
                    />
                  </li>
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco4.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco4.png`"
                    />
                  </li>
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco5.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco5.png`"
                    />
                  </li>
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco6.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco6.png`"
                    />
                  </li>
                  <li>
                    ...
                    <el-image
                        ...
                        :fit="'scale-down'"
                        class="image"
                        :preview-src-list="['http://10.214.242.155:7667/img/background/coco7.png']"
                        :src="`http://10.214.242.155:7667/img/background/coco7.png`"
                    />
                  </li>
                </ul>
      ...
      <el-dialog class="scrollable" v-model="dialogVisible5" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible5 = false" :append-to-body="true" title="CUB数据集介绍"  >
        <div class="dialog-container">
          <div class="language-switch">
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/cub1.jpeg']"
                    :src="`http://10.214.242.155:7667/img/background/cub1.jpeg`"
                />
                <div style="text-align: left; margin: 10px 0;">
...
<!--                </div>-->
      ...
      <el-dialog class="scrollable" v-model="dialogVisible6" style="width:30%; height:50%; text-align: center; overflow: auto;"
                 :draggable="true" @close="dialogVisible6 = false" :append-to-body="true" title="CUB数据集介绍"  >
        <div class="dialog-container">
          <div class="language-switch">
            <el-tabs v-model="activeTab" type="border-card" class="demo-tabs" :stretch=true>
              <el-tab-pane label="中文" name="cn">
                ...
                <el-image
                    ...
                    :fit="'scale-down'"
                    class="image"
                    :preview-src-list="['http://10.214.242.155:7667/img/background/cars.jpg']"
                    :src="`http://10.214.242.155:7667/img/background/cars.jpg`"
                />
    ...
    <div v-else style="background: linear-gradient(transparent,#78E9E8 100%);">
...
const fileList = ref(['10.214.242.155:7667/Cifar/0_1740.jpg','10.214.242.155:7667/Cifar/3_10557.jpg','10.214.242.155:7667/Cifar/7_18534.jpg',
                '10.214.242.155:7667/originalImgNet/n01798484/n01798484_14557.JPEG','10.214.242.155:7667/originalImgNet/n01491361/n01491361_3683.JPEG',
                '10.214.242.155:7667/originalImgNet/n01440764/n01440764_6628.JPEG','10.214.242.155:7667/originalVOC/2007_000648.jpg',
                '10.214.242.155:7667/originalVOC/2007_005086.jpg','10.214.242.155:7667/originalVOC/2007_000836.jpg','10.214.242.155:7667/cocoimg/000000165012.jpg',
                '10.214.242.155:7667/cocoimg/000000189617.jpg','10.214.242.155:7667/cocoimg/000000308175.jpg','10.214.242.155:7667/CUB/014_Indigo_Bunting/Indigo_Bunting_0004_13195.jpg'
                ,'10.214.242.155:7667/CUB/038_Great_Crested_Flycatcher/Great_Crested_Flycatcher_0024_29516.jpg','10.214.242.155:7667/CUB/028_Brown_Creeper/Brown_Creeper_0075_24947.jpg',
                '10.214.242.155:7667/CARS/00009.jpg','10.214.242.155:7667/CARS/00082.jpg','10.214.242.155:7667/CARS/00246.jpg']);
...
.demo-image{
  /*background: url("http://10.214.242.155:7667/img/background/background_preview.jpg") no-repeat 0% 20%/ cover;*/
