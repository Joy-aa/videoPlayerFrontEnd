<template>
  <el-container>
<!--    <el-aside style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3)), url('http://10.214.242.155:7667/img/background/ImageNet_aside.png') no-repeat 0% 20%/ cover; width: 750px; padding: 20px">-->
...
<!--          </el-row>-->
          ...
          <div class="holly-data">
            <el-link target="_blank"
                     :href="`http://10.214.242.155:7667/Prototype/test_${chosenModel}_full/pruned_and_projected/treevis.pdf`" :underline="false">
              <el-button style="border-color: #000000;" size="large" type="primary" plain>查看高清矢量图</el-button>
            </el-link>
            <el-link  :href="'http://10.214.242.155:7667/Prototype/test_'+chosenModel+'_full/pruned_and_projected/node_vis.zip'" :underline="false">
...
<!--          </el-row>-->
          ...
          <div class="holly-data">
            <el-link target="_blank"
                     :href="`http://10.214.242.155:7667/Prototype/test_${chosenModel}_pruned/pruned_and_projected/treevis.pdf`" :underline="false">
              <el-button style="border-color: #000000;" size="large" type="primary" plain>查看高清矢量图</el-button>
            </el-link>
            <el-link target="_blank"  :href="'http://10.214.242.155:7667/Prototype/test_'+chosenModel+'_pruned/pruned_and_projected/node_vis.zip'" :underline="false">
              <el-button style="border-color: #000000;" size="large" type="warning" plain>下载节点原型</el-button>
            </el-link>
          </div>
...
//
//   // axios({
//   //   url: 'http://10.214.242.155:7667/home/OIPDL_codes/CUB_CARS/tests/test_cub1_full/pruned_and_projected/treevis.pdf',
//   //   method: 'GET',
//   //   responseType: 'blob',
//   // }).then((response) => {
//   //   const url = window.URL.createObjectURL(new Blob([response.data]));
...
//
//   // axios({
//   //   url: 'http://10.214.242.155:7667/home/OIPDL_codes/CUB_CARS/tests/test_cub1_full/pruned_and_projected/node_vis.zip',
//   //   method: 'GET',
//   //   responseType: 'blob',
//   // }).then((response) => {
//   //   const url = window.URL.createObjectURL(new Blob([response.data]));
...
async function startRecognize() {
  ...
  showList.value[0] = "10.214.242.155:7667/Prototype/test_" + chosenModel.value + "_full/pruned_and_projected/treevis.png";
  showList2.value[0] = "10.214.242.155:7667/Prototype/test_" + chosenModel.value + "_pruned/pruned_and_projected/treevis.png";
