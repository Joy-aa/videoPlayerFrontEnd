...
<!--        </div>-->
        ...
        <div class="holly-data">
          <el-link target="_blank"
                   :href="`http://10.214.242.155:7667/Prototype/test_${chosenModel}_pooled/pruned_and_projected/treevis.pdf`" :underline="false">
            <el-button style="border-color: #000000;" size="large" type="primary" plain>查看高清矢量图</el-button>
          </el-link>
          <el-link target="_blank"  :href="'http://10.214.242.155:7667/Prototype/test_'+chosenModel+'_pooled/pruned_and_projected/node_vis.zip'" :underline="false">
...
async function startRecognize() {
  ...
  showList2.value[0] = "10.214.242.155:7667/Prototype/test_" + chosenModel.value + "_pooled/pruned_and_projected/treevis.png";
