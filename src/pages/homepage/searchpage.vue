...
<!--        搜索视频-->
        <el-tab-pane style="font-size: 16px" label="视频" name="first">
          <el-row>
            <!-- 四个视频-->
            <div v-for="(video, index) in store.state.relatedvideos" :key="index" @click="clickvideo"  :style="{ height: store.state.heights.at(index) + 80 + 'px' }" class="video-item">
                ...
                <div class="video-content">
                  <div class="video-info">
                    ...
                    <el-row style="margin-top: -15px;">
                      <div class="likebutton" style="width: 30px;height: 30px">
